...
export  { CovidSummaryResponse, CountrySummaryResponse } from './covid'
...
function fetchCountryInfo(countryName: string, status: CovidStatue): Promise<AxiosResponse<CountrySummaryResponse>> {
